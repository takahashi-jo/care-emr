...
const VitalsTrend = ({ vitals }: { vitals: VitalSign[] }) => {
  ...
  const metrics: { key: string; title: string; unit: string; thresholds?: number[]; lines: { dataKey: string; name: string; color: string; abnormal?: (v: number) => boolean }[] }[] = [
    ...
    { key: 'respiratoryRate', title: t('vitals.colRR'), unit: t('vitals.unitRR'), thresholds: [10, 24], lines: [{ dataKey: 'respiratoryRate', name: t('vitals.colRR'), color: '#2f5b95', abnormal: isVitalAbnormal.respiratoryRate }] },
